...
public class DetailIntro_Festival {
	...
	// Default Constructor
	public DetailIntro_Festival() {
		
	}
	
	// Constructor using Fields
	public DetailIntro_Festival(String contentid, String contenttypeid, String agelimit, String bookingplace,
