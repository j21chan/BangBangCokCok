...
public class DetailIntro_Stay {
	...
	// Default Constructor
	public DetailIntro_Stay() {
		
	}
	
	// Constructor Using Fields
	public DetailIntro_Stay(String contentid, String contenttypeid, String accomcountlodging, String benikia,
			String checkintime, String checkouttime, String chkcooking, String foodplace, String goodstay, String hanok,
			String infocenterlodging, String parkinglodging, String pickup, int roomcount, String reservationlodging,
			...
			String publicbath, String publicpc, String sauna, String seminar, String sports) {
